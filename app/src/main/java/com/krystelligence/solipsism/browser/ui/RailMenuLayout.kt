...
/**
 * The user-owned arrangement of the Solipsism side rail and overflow menu.
 *
 * The rail deliberately has three independent regions. This preserves the original Solipsism
